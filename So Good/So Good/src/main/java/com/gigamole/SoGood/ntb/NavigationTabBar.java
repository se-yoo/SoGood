...
package com.gigamole.SoGood.ntb;
...
import com.gigamole.SoGood.R;
import com.gigamole.SoGood.behavior.NavigationTabBarBehavior;
...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    private final static int DEFAULT_INACTIVE_COLOR = Color.parseColor("#000000"); //탭기존색
    private final static int DEFAULT_ACTIVE_COLOR = Color.WHITE; //탭누르면색상변화
    private final static int DEFAULT_BG_COLOR = Color.parseColor("#ffffff"); //탭색깔
